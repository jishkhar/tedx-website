...
const Home = () => {
 ...
 <section className="bg-black py-0">
  <div className="container mx-auto flex flex-col lg:flex-row items-center">
    ...
    <div className="lg:w-1/2 mt-64 text-left lg:mb-0 lg:pt-50"> {/* Added lg:pt-20 for padding on top */}
      {/* TEDx2024 Header */}
      <h1 className="text-white text-5xl font-semibold mb-2 ml-16" style={lexend}>
        TEDx2024
      </h1>

      {/* "BEYOND" and "THE" in one row */}
      ...
      {/* "CANVAS" positioned directly below */}
      ...
      <button className="bg-red-600 text-3xl mt-20 ml-16 text-white py-2 px-6 rounded-full hover:bg-red-700" style={lexend}>
