  ...
  return (
    <>
      <div className='flex flex-col justify-center items-center w-[90%] mx-auto my-14'>
        ...
        <div id="years" className='flex gap-12 text-2xl py-10'>
          {['2024', '2023', '2022', '2021', '2020', '2019'].map((year) => (
            <button
              key={year}
              className='bg-gray-900 py-3 px-6 rounded-full cursor-pointer'
        ...
        <div id="2022" className={`grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 ${visibleYear === '2022' ? '' : 'hidden'}`}>
          {/* No cards provided for 2022 */}
        </div>
